...
| <span style="display:inline-flex;gap:2px;vertical-align:middle"><span title="#00FF41" style="display:inline-block;width:28px;height:28px;border:1px solid #0002;background:#00FF41"></span><span title="#3DDC84" style="display:inline-block;width:28px;height:28px;border:1px solid #0002;background:#3DDC84"></span><span title="#080B08" style="display:inline-block;width:28px;height:28px;border:1px solid #0002;background:#080B08"></span></span> | **Matrix** | `matrix` | dark |
